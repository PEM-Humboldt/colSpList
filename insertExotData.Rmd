...
In order to show how to work with the colSpList API and the threatened species, we will use the species list from the GRIIS, concerning the endemic bird species of Colombia (publicly available as a gbif dataset at <https://www.gbif.org/dataset/168568e7-eb5f-4ef6-8c59-f73ceaf57e91>)
...
##### Problems
The most important problem we face here is that most taxa were already present in the previous list, so we need to resolve the conflicts before going further.
